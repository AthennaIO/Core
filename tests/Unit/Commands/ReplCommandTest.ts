...
export default class ReplCommandTest extends BaseCommandTest {
  @Test()
  public async shouldBeAbleToRunTheReplApplication({ assert }: TestContext) {
  ...
  @Test()
  public async shouldBeAbleToRunTheReplApplicationWithDifferentNodeEnv({ assert }: TestContext) {
